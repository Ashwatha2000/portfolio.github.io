...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const titles = [
        ...
        { title: 'Software Developer', description: 'Building scalable and efficient software solutions.' },
        { title: 'Full Stack Developer', description: 'Building scalable and efficient software solutions.' },
        { title: 'Back-End Developer', description: 'Building scalable and efficient software solutions.' },
        { title: 'Fast Learner', description: 'Quickly adapting to new technologies and challenges.' },
        { title: 'Creative Thinker', description: 'Innovating and brainstorming unique ideas.' },
        { title: 'Problem Solver', description: 'Tackling complex issues with effective strategies.' }
    ];
    let current = 0;
